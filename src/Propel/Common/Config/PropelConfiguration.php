                ...
                ->arrayNode('generator')
                    ...
                    ->children()
                        ...
                        ->arrayNode('builders')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('resolver')->cannotBeEmpty()->defaultValue('\Propel\Generator\Builder\ResolverBuilder')->end()
                            ->end()
                        ->end()
                        ->arrayNode('objectModel')
                            ...
                            ->children()
                                ...
                                ->scalarNode('namespaceEvent')->defaultValue('Event')->end()
                                ...
                                ->arrayNode('builders')
                                    ...
                                    ->children()
                                        ...
                                        ->scalarNode('event')->cannotBeEmpty()->defaultValue('\Propel\Generator\Builder\Om\EventBuilder')->end()
